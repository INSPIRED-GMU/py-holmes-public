...
class TestCircleArea(unittest.TestCase):    # Each test method within this class must start with the word "test".  Each method here constitutes 1 test, and is caled a "test case".
    ...
    def test_without_asserts_throws_exception(self):
        """Test method intentionally left without any asserts for purposes of testing py_holmes.py.
        Throws an exception.
        """
        my_num = 10 / 0
        if my_num == 5:
    ...
    def test_without_asserts_no_exception(self):
        """Test method intentionally left without any asserts for purposes of testing py_holmes.py
